...
public static <T> List<T> fromJsonArray(String json, Class<T> clazz)
  {
    ...
    return (List)fromJsonViaJavaType(json, javaType);
  }
...
public static Map<String, Object> beanToMap(Object o)
  {
    if (o == null) {
      return null;
        ...
        return (Map)objectMapper.convertValue(o, Map.class);
  }
  
  public static JavaType getParametricType(Class<?> paramtricClass, Class<?> elementClass)
  {
    return objectMapper.getTypeFactory().constructParametricType(paramtricClass, new Class[] { elementClass });
  }
